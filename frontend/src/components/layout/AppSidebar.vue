<template>
  ...
  >
      ...
      <div v-if="authStore.isAdmin">
        ...
        <ul class="space-y-1">
          ...
          <li>
            ...
            >
              <span class="shrink-0"><svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg></span>
              <span v-if="uiStore.isSidebarOpen">사용 설명서</span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <!-- Version Footer -->
    <div class="px-4 py-3 border-t border-slate-800 text-3xs text-slate-500 text-center shrink-0">
      <span v-if="uiStore.isSidebarOpen">AMS ERP v{{ appVersion }}</span>
...
const familyItems = [
  ...
  },
  {
    name: 'dcim',
    label: 'DCIM (고객사 자산관리)',
    href: 'http://ezenuri.synology.me:8081/',
    icon: `<svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2 1.5 3 4 3h8c2.5 0 4-1 4-3V7c0-2-1.5-3-4-3H8C5.5 4 4 5 4 7z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16M4 14h16M8 7h.01M8 11h.01M8 15h.01" /></svg>`
  },
  {
    name: 'groupware',
    label: '사내그룹웨어',
